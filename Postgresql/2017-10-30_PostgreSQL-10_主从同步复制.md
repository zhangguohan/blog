...
#
primary_conninfo = 'host=139.159.247.78 port=5432  user=replication password=6220104 application_name=ghan' # e.g. 'host=localhost po  //如果设置application_name=* 将复制所有数据库 
rt=5432'
